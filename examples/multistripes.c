...
int main() {
  ...
  for(y=0; y<29;y++){
    ...
    colors[y+30] = APA102_CreateFrame(1, 0, 255, 255);
  }
  colors[58] = APA102_CreateFrame(1, 255, 255, 0);
  colors[59] = APA102_CreateFrame(1, 255, 255, 0);
  colors[60] = 0;
  ...
  for(x = 0; x < 10000000; x++) {
    ...
    APA102_MultiStripes(strip, colors,  1, 0, 0, 0);
